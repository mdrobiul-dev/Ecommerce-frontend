     ...
     <nav className="flex justify-between items-center px-40 h-[50px]">
        ...
        <div>
          <ul className="flex gap-10 text-[#141718] font-normal text-[16px]">
            ...
            <li>
              <a href="#" className="cursor-pointer">Shop <span><ChevronDown className="inline" size={20}/></span></a>
            </li>
            <li>
              <a href="#" className="cursor-pointer">Product <span><ChevronDown className="inline" size={20}/></span></a>
            </li>
            <li>
